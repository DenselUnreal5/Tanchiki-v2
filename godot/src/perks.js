...
export const PERKS = [
  // ---------------------------------------------------------------- огонь
  {
    ...
    icon: '🔫',
    desc: 'Залп из двух параллельных снарядов. Удваивает огневую мощь по прямой линии.',
    category: 'fire',
    flags: ['doubleShot'],
  },
  {
    ...
    name: 'Выстрел веером',
    icon: '🌊',
    desc: 'Веер из трёх снарядов (каждый наносит 45% урона). Накрывает широкую зону перед танком.',
    category: 'fire',
    flags: ['fanShot'],
  },
  {
    ...
    icon: '⚡',
    desc: 'Ускоряет перезарядку на 40% и снижает нагрев орудия при стрельбе.',
    category: 'fire',
  ...
  },
  {
    ...
    name: 'Взрывные пули',
    icon: '💥',
    desc: 'Снаряды детонируют при попадании, нанося урон по площади и мгновенно круша кирпичные стены.',
    category: 'fire',
    flags: ['explosive'],
  },
  {
    ...
    icon: '🎯',
    desc: 'Бронебойный сердечник прошивает первую преграду и летит дальше без потери убойной силы.',
    category: 'fire',
    flags: ['piercing'],
  },
  ...
  // ---------------------------------------------------------------- защита
  {
    ...
    name: 'Тяжёлая броня',
    icon: '🛡',
    desc: 'Усиленные бронелисты повышают максимальный запас прочности танка на 50%.',
    category: 'defense',
    mods: { maxHPMult: 1.5 },
  },
  {
    ...
    name: 'Регенерация',
    icon: '❤',
    desc: 'Полевой наноремонт восстанавливает 1 ед. прочности в секунду (60 HP в минуту).',
    category: 'defense',
  ...
  },
  {
    ...
    name: 'Отражение',
    icon: '🪞',
    desc: 'Динамическая защита отражает 20% полученного урона обратно в атакующего.',
    category: 'defense',
  ...
  },
  {
    ...
    name: 'Уклонение',
    icon: '💨',
    desc: 'Маневренность даёт 15% шанс полностью избежать попадания снаряда.',
    category: 'defense',
  ...
  },
  {
    ...
    name: 'Энергощит',
    icon: '🔵',
    desc: 'Силовое поле поглощает 30 ед. урона и полностью восстанавливается каждые 30 секунд.',
    category: 'defense',
    flags: ['shield'],
  },
  ...
  // ---------------------------------------------------------------- скорость
  {
    ...
    name: 'Спринтер',
    icon: '👟',
    desc: 'Форсированная трансмиссия увеличивает предельную скорость танка на 25%.',
    category: 'speed',
    mods: { speedMult: 1.25 },
  },
  {
    ...
    icon: '🔄',
    desc: 'Перезарядка быстрее на 30%. Позволяет вести непрерывный подавляющий огонь.',
    category: 'speed',
  ...
  // ---------------------------------------------------------------- особые
  {
    ...
    name: 'Миноукладчик',
    icon: '💣',
    desc: 'Установка до 3 мин на поле боя. Подрываются при наезде противника.',
    category: 'special',
    flags: ['mines'],
  },
  ...
  // ------------------------------------------------------- челленджи
  {
    ...
    name: 'Таран',
    icon: '🚛',
    desc: 'Удвоенный урон при лобовом столкновении с вражеским танком.',
    category: 'challenge',
    mods: { ramMult: 2 },
  ...
  },
  {
    ...
    name: 'Толстая броня',
    icon: '🧱',
    desc: 'Снижает весь входящий урон на 20%, но ваши снаряды перестают ломать кирпич.',
    category: 'challenge',
  ...
  },
  {
    ...
    name: 'Амфибия',
    icon: '🐸',
    desc: 'Герметичный корпус позволяет преодолевать водные преграды без урона от затопления.',
    category: 'challenge',
    flags: ['amphibious'],
  ...
  },
  {
    ...
    name: 'Лесной житель',
    icon: '🌲',
    desc: 'Позволяет беспрепятственно проходить сквозь деревья, не ломая их и сохраняя маскировку.',
    category: 'challenge',
    flags: ['forest'],
  ...
  },
  {
    ...
    name: 'Магнит',
    icon: '🧲',
    desc: 'Вдвое увеличивает радиус притяжения и подбора аптечек.',
    category: 'challenge',
  ...
  },
  {
    ...
    name: 'Снайпер',
    icon: '🔭',
    desc: 'Снаряды летят на 40% быстрее и наносят на 15% больше урона.',
    category: 'challenge',
  ...
  },
  {
    ...
    name: 'Берсерк',
    icon: '😤',
    desc: 'Когда запас прочности падает ниже 40%, урон всех орудий возрастает на 60% (×1.6).',
    category: 'challenge',
    flags: ['berserk'],
  ...
  },
  {
    ...
    name: 'Камикадзе',
    icon: '💀',
    desc: 'При гибели танк взрывается, накрывая мощной взрывной волной всех врагов поблизости.',
    category: 'challenge',
    flags: ['kamikaze'],
  ...
  },
  {
    ...
    name: 'Турбо',
    icon: '🚀',
    desc: 'Каждое уничтожение вражеского танка дарит мощное 4-секундное ускорение (×1.5).',
    category: 'challenge',
  ...
  },
  {
    ...
    name: 'Тень',
    icon: '🌑',
    desc: 'Уничтожение танка дарит 5 секунд полной невидимости на экранах и миникартах противников.',
    category: 'challenge',
  ...
  },
  {
    ...
    name: 'Вампир',
    icon: '🧛',
    desc: '15% любого нанесённого урона мгновенно восстанавливает собственную броню.',
    category: 'challenge',
