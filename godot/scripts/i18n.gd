...
var EN := {
	...
	"net.err.noSteamCode": "Codes require Steam — direct connection is below.",
	"net.err.noSteamInvite": "Invites require Steam — direct connection is below.",
	"net.err.joinLobby": "Could not enter the lobby",
	"net.invite.create": "Create game",
	"net.invite.createHint": "Invite a friend from the lobby, or via ‘Join Game’ in your Steam friends list.",
	"net.invite.friend": "Invite a friend",
	"net.invite.incoming": "{name} invites you to play",
	"net.invite.accept": "Accept",
	"net.code.join": "Join",
	"net.code.enter": "Code",
	"net.code.label": "or give the code to the other player",
	"net.code.creating": "Creating the lobby…",
	"net.code.searching": "Connecting…",
	"net.code.notfound": "No lobby found with code {code}",
	"net.code.badcode": "The code is four digits",
