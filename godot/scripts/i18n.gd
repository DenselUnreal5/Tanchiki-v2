...
var EN := {
	...
	"set.music": "Music",
	"set.music.hint": "There is no music yet: all audio is procedural sound effects. The slider is already wired to its own bus and will work as soon as a track is added.",
	"fx.off": "off",
	"fx.medium": "medium",
	"fx.high": "high",
