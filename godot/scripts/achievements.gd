...
#
# @tool: без этого статический LIST ненадёжен в редакторе Godot — см. Cfg
...
const LIST := [
	...
	{"id": "long_20", "name": "Снайпер", "desc": "20 убийств с 50 м", "icon": "🔭", "stat": "longKills", "need": 20, "reward": 50},
	...
	{"id": "eagle_ear", "name": "Орлиный слух", "desc": "15 убийств с 100 м", "icon": "🦅", "stat": "sniperKills", "need": 15, "reward": 90},
